...
from utils import sort_competition_by_date
...
def showSummary():
    try:
        ...
        return render_template('welcome.html',club=club,past_competitions=compet['past_compet'], actually_competitions=compet['actually_compet'])
    except IndexError:
